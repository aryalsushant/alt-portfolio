...
import { FaPython, FaJs, FaReact, FaNodeJs, FaAws, FaGitAlt, FaLinux, FaDatabase } from 'react-icons/fa';
import { SiTypescript, SiCplusplus, SiFlask, SiExpress, SiTensorflow, SiNumpy, SiMatplotlib, SiSeaborn, SiProphet, SiMongodb, SiSnowflake, SiHtml5, SiCss3, SiClerk } from 'react-icons/si';
    ...
    <main className="container mx-auto py-16 max-w-4xl">
      ...
      >
        ...
        <ul className="text-lg text-gray-700 dark:text-gray-300 space-y-2 mb-6">
          ...
          <li>🤖 Accepted into Cornell Tech's AI/ML Fellowship (2025)</li>
      ...
      >
        ...
        <div className="bg-light-background dark:bg-dark-background rounded-lg shadow p-4 border-l-4 border-primary mb-2">
          ...
          <div>Bachelor's in Computer Science & Mathematics</div>
